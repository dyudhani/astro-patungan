...
const dict = {
  id: {
    ...
    btnRemindAll: "📣 Kirim reminder ke yang belum bayar",
    reminderProgress: "Reminder {current}/{total}: {name}",
    btnRemindSend: "📲 Kirim ke {name}",
    btnRemindSkip: "Lewati",
    btnRemindCancel: "Batal",
    allPaidToast: "Semua orang sudah lunas 🎉",
    reminderDoneToast: "Semua reminder terkirim ✅",
    paidLabel: "Lunas",
    paidBadge: "LUNAS",
  ...
  en: {
    ...
    btnRemindAll: "📣 Remind everyone unpaid",
    reminderProgress: "Reminder {current}/{total}: {name}",
    btnRemindSend: "📲 Send to {name}",
    btnRemindSkip: "Skip",
    btnRemindCancel: "Cancel",
    allPaidToast: "Everyone's already paid 🎉",
    reminderDoneToast: "All reminders sent ✅",
    paidLabel: "Paid",
    paidBadge: "PAID",
